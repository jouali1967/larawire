...
class EditSanction extends Component
{
    ...
    public function mount(Sanction $sanction)
    {
        $this->sanction = $sanction;
        $this->personne_id = $sanction->personne_id;
        $this->montant = $sanction->montant;
        $this->date_sanction = $sanction->date_sanction;
        $this->motif_sanction = $sanction->motif_sanction;
        $this->selectedPersonne = $sanction->personne;
    ...
    public function save()
    {
        ...
        $this->sanction->update($validated);
    ...
    {
        return view('livewire.sanctions.edit-sanction');
    }
} 