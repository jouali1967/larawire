<div class="card">
    <div class="card-header bg-primary text-white">
        <h3 class="card-title mb-0">Modifier la sanction</h3>
    </div>
        ...
        <form wire:submit="save">
            ...
            <div class="row mb-3">
                ...
                <div class="col-8">
                    ...
                    <div class="input-group">
                        <input id="datepicker" 
                               wire:model="date_sanction" 
                               class="form-control @error('date_sanction') is-invalid @enderror"
            ...
            <div class="mb-3">
                ...
                <textarea wire:model="motif_sanction" 
                          class="form-control @error('motif_sanction') is-invalid @enderror"
                          rows="3"
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('sanctions.index') }}" class="btn btn-secondary me-2">
